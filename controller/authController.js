...
const createToken = (user) => {
  return jwt.sign({ id: user._id, email: user.email, userId: user.userId }, process.env.JWT_SECRET);
};
...
exports.signup = async (req, res) => {
  try {
    ...
    const user = await User.create({ name, email, password, userId, referCode });
